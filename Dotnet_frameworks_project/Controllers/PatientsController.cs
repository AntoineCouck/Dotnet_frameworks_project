...
namespace Dotnet_frameworks_project.Controllers
{
    public class PatientsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,FirstName,LastName,Birthday")] Patient patient)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FirstName,LastName,Birthday")] Patient patient)
        {
            if (id != patient.Id)
            {
                return NotFound();
